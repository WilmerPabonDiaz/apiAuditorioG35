...
public class AdministradoresControlador {
    ...
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Administradores actualizarAdministradores(@RequestBody Administradores administrador){
        return administradoresServicio.actualizar(administrador);
    ...
    public boolean deleteAdministrador(@PathVariable("id") int id){
        return administradoresServicio.borrar(id);
    }
}
