...
public class CalificacionControlador {
    ...
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Calificacion actualizarCalificaciones(@RequestBody Calificacion calificacion){
        return calificacionServicio.actualizar(calificacion);
    ...
    public boolean deleteCalificacion(@PathVariable("id") int id){
        return calificacionServicio.borrar(id);
    }
